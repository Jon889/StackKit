/** Private constants
 ...
 This file contains all of the constants used internally, most notably those used as keys in the dictionaries returned by the API
 */
...
extern NSString * const SKAPIAccount_ID;
extern NSString * const SKAPIAward_Count;
extern NSString * const SKAPIAwards;
extern NSString * const SKAPIBadge_Counts_Bronze;
extern NSString * const SKAPIBadge_Counts_Gold;
extern NSString * const SKAPIBadge_Counts_Silver;
...
extern NSString * const SKAPIIs_Employee;
...
extern NSString * const SKAPIReputationChangeDay;
extern NSString * const SKAPIReputationChangeMonth;
extern NSString * const SKAPIReputationChangeQuarter;
extern NSString * const SKAPIReputationChangeWeek;
extern NSString * const SKAPIReputationChangeYear;
...
extern NSString * const SKAPITimed_Penalty_Date;
